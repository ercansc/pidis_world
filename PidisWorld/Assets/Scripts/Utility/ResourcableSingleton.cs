        ...
        get
        {
            ...
            //lock (s_oLock)
            {
                if (s_instance == null)
                {
                    ...
                    if (s_instance == null)
                    {
                        GameObject resource = Resources.Load(typeof(T).Name + "_Singleton") as GameObject;
                        GameObject singleton = default(GameObject);
                        if (resource != null)
                        {
                            singleton = Instantiate(resource);
                            s_instance = singleton.GetComponent<T>();
                        }
                        if (singleton == null)
                        {
